...
| one-port-subscription-plan | `1940744` | Persistent one-service Codex and Grok plan, exact pass-through amendment | `[~]` pending Claude r2 after client-route/query/installer fixes |
