...
| one-port-subscription-plan | `2aeca41` | Persistent one-service Codex and Grok plan, exact pass-through amendment | `[~]` pending Claude r4 after durability/ownership/isolation fixes |
