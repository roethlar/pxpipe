...
| context-hijack-correction-plan | `5cfcf2b` | Remove context rewriting, invalid requests, and negative returns | `[~]` accepted r2; dropped-glyph clarification pending r3 |
