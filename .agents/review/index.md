...
| one-port-subscription-plan | `1bf3f5e` | Persistent one-service Codex and Grok plan, exact pass-through amendment | `[~]` reopened after r1; coder found required client-route/query/installer gaps |
